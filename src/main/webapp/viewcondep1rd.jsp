        ...
        if (currentUser != null) {
            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root", "student");
                ...
                if (!rs.next()) {
                    ...
                    if (userType != 4) {
                    	out.println("<h1>Vizualizarea tuturor concediilor din departamentul meu pe anul curent RESPINSE DIRECTOR</h1><br>");
                        ...
                        try (PreparedStatement stmt = connection.prepareStatement("SELECT " +
                                ...
                                "WHERE YEAR(c.start_c) = YEAR(CURDATE()) and d.id_dep = ? and c.status = -2;")) {  
