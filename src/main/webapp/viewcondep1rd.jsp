        ...
        if (currentUser != null) {
            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root", "student");
                ...
                if (!rs.next()) {
                    ...
                    if (userType != 4) {
                        out.println("<h1>Vizualizarea tuturor concediilor din departamentul meu per total RESPINSE DIRECTOR</h1><br>");
                        ...
                        try (PreparedStatement stmt = connection.prepareStatement("SELECT concedii.id as nr_crt, departament.nume_dep as departament, nume, prenume, " + 
                            ...
                            "NATURAL JOIN tipuri NATURAL JOIN departament JOIN concedii ON concedii.id_ang = useri.id JOIN statusuri ON concedii.status = statusuri.status where concedii.status = -2 and departament.id_dep = ?")) {
