        ...
        if (currentUser != null) {
            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root", "student");
                ...
                if (!rs.next()) {
                    ...
                    if (userType == 0) {
                    	out.println("<h1>Vizualizarea tuturor concediilor din anul curent RESPINSE DIRECTOR</h1><br>");
                        ...
                        try (PreparedStatement stmt = connection.prepareStatement("SELECT " +
                                ...
                                "WHERE YEAR(c.start_c) = YEAR(CURDATE()) and c.status = -2;")) {    
                        ...
                        // e alt tip de user si nu director =(
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
