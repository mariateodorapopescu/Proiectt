                   ...
                   <%
                        try (PreparedStatement stmt = connection.prepareStatement("SELECT * from departament;")) {
                            ...
                            while (rs1.next()) {
                                ...
                                out.println("<td data-label='Status'><span class='status-icon status-neaprobat'><a href='NewFile1.jsp?id=" + rs1.getInt("id_dep")+ "'><i class='ri-edit-circle-line'></i></a></span></td>");
