        ...
        if (currentUser != null) {
            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root", "student");
                ...
                if (!rs.next()) {
                    ...
                    out.println("</script>"); out.println("<p>Nu exista date.</p>");
                } else {
                    int userType = rs.getInt("tip");
                    int userdep = rs.getInt("id_dep");
                    if (userType != 4) {
                    	out.println("<h1>Vizualizarea tuturor concediilor din departamentul meu pe anul curent APROBATE SEF</h1><br>");
                        ...
                        try (PreparedStatement stmt = connection.prepareStatement("SELECT " +
                                ...
                                "WHERE YEAR(c.start_c) = YEAR(CURDATE()) and d.id_dep = ? and c.status = 1;")) {  
