            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root", "student");
                ...
                if (rs.next()) {
                    ...
                    if (userType != 0) {
                        ...
                        out.println("<h1>Selectati statusul si departamentul concediilor de vizualizat</h1>");
                        out.print("<form action='");
                        out.print(request.getContextPath());
                        out.println("/viewcondeps2.jsp' method='post'>");
                        out.println("<table style='width: 80%'>");
                        
                        out.println("<tr><td>Status</td><td><select name='iddep'>");
                        ...
                        out.println("<tr><td>Departament</td><td><select name='dep'>");
