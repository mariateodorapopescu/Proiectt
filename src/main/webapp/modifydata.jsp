...
<%
    ...
    if (sess != null) {
        ...
        if (username != null && !username.isEmpty()) {
            ...
            out.println("<h1>Introduceti codul primit la angajare</h1>");
            out.print("<form action='" + request.getContextPath() + "/modifusr2.jsp' method='post'>");
            ...
            out.println("</form>");
            out.println("</div>");
            out.println("<a href='despr.jsp'>Inapoi</a>");
        } else {
