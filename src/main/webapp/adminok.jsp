        ...
        <ul>
            ...
            <div style="background:<%out.println(sidebar); %>; color: <%out.println(text); %>" class="menulist">
                <li style="--bg:<%out.println(accent); %>"  class="active">
                     <a style=" color: <%out.println(text); %>" href="homeadmin.jsp" class="load-content" target="iframe">
                        <div class="siiconn">
                ...
                <li style="--bg: <%out.println(accent); %>">
                    <a href="viewang3.jsp" class="load-content" target="iframe">
                        <div class="siiconn">
                ...
                <li style="--bg: <%out.println(accent); %>">
                    <a href="viewdep2.jsp" class="load-content" target="iframe">
                        <div class="siiconn">
