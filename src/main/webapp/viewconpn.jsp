        ...
        if (currentUser != null) {
            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root", "student");
                ...
                if (!rs.next()) {
                    ...
                    if (userType != 4) {
                    	out.println("<h1>Vizualizarea tuturor concediilor personale din anul curent IN ASTEPTARE</h1><br>");
                        ...
                        try (PreparedStatement stmt = connection.prepareStatement("SELECT " +
                                ...
                                "WHERE YEAR(c.start_c) = YEAR(CURDATE()) and username = ? and c.status = 0;")) {    
