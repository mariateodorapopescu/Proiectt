            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root", "student");
                ...
                if (rs.next() == false) {
                    ...
                    if (rs.getString("tip").compareTo("0") != 0) {
                        ...
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament / an</a><br>");
                        ...
                        out.println("<p><b>Aprobate director</b></p>");
                        out.println("<b><a href='viewcontota.jsp'>Vizualizare concedii din toata institutia / an</a></b><br>");
                        out.println("<b><a href='viewconpad.jsp'>Vizualizare concedii personale / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament / an</a><br>");
                        out.println("<b><a href='viewcondep1ad.jsp'>Vizualizare concedii din departamentul meu / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg din departamentul meu / an</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg dintr-un departament / an (doar coleg, nu conteaza departamentul gen)</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii personale pe o anumita perioada</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament pe o anumita perioada</a><br>");
                        ...
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg din departamentul meu pe o anumita perioada </a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg dintr-un departament pe o anumita perioada (doar coleg, nu conteaza departamentul gen)</a><br>");
                        out.println("<p><b>Aprobate sef</b></p>");
                        out.println("<b><a href='viewcontota2.jsp'>Vizualizare concedii din toata institutia / an</a></b><br>");
                        out.println("<b><a href='viewconpas.jsp'>Vizualizare concedii personale / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament / an</a><br>");
                        out.println("<b><a href='viewcondep1as.jsp'>Vizualizare concedii din departamentul meu / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg din departamentul meu / an</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg dintr-un departament / an (doar coleg, nu conteaza departamentul gen)</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii personale pe o anumita perioada</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament pe o anumita perioada</a><br>");
                        ...
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg din departamentul meu pe o anumita perioada </a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg dintr-un departament pe o anumita perioada (doar coleg, nu conteaza departamentul gen)</a><br>");
                       	out.println("<p><b>Noi</b></p>");
                       	out.println("<b><a href='viewcontotn.jsp'>Vizualizare concedii din toata institutia / an</a></b><br>");
                       	out.println("<b><a href='viewconpn.jsp'>Vizualizare concedii personale / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament / an</a><br>");
                        out.println("<b><a href='viewcondep1n.jsp'>Vizualizare concedii din departamentul meu / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg din departamentul meu / an</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg dintr-un departament / an (doar coleg, nu conteaza departamentul gen)</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii personale pe o anumita perioada</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament pe o anumita perioada</a><br>");
                        ...
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg din departamentul meu pe o anumita perioada </a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg dintr-un departament pe o anumita perioada (doar coleg, nu conteaza departamentul gen)</a><br>");
                       	out.println("<p><b>Respinse sef</b></p>");
                       	out.println("<b><a href='viewcontotr2.jsp'>Vizualizare concedii din toata institutia / an</a></b><br>");
                       	out.println("<b><a href='viewconprs.jsp'>Vizualizare concedii personale / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament / an</a><br>");
                        out.println("<b><a href='viewcondep1rs.jsp'>Vizualizare concedii din departamentul meu / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg din departamentul meu / an</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg dintr-un departament / an (doar coleg, nu conteaza departamentul gen)</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii personale pe o anumita perioada</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament pe o anumita perioada</a><br>");
                        ...
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg din departamentul meu pe o anumita perioada </a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg dintr-un departament pe o anumita perioada (doar coleg, nu conteaza departamentul gen)</a><br>");
                        out.println("<p><b>Respinse director</b></p>");
                        out.println("<b><a href='viewcontotr.jsp'>Vizualizare concedii din toata institutia / an</a></b><br>");
                        out.println("<b><a href='viewconprd.jsp'>Vizualizare concedii personale / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament / an</a><br>");
                        out.println("<b><a href='viewcondep1rd.jsp'>Vizualizare concedii din departamentul meu / an</a></b><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg din departamentul meu / an</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii unui coleg dintr-un departament / an (doar coleg, nu conteaza departamentul gen)</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii personale pe o anumita perioada</a><br>");
                        out.println("<a href='viewcolegi.jsp'>Vizualizare concedii dintr-un departament pe o anumita perioada</a><br>");
