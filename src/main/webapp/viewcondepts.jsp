            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root", "student");
                ...
                if (rs.next()) {
                    ...
                    if (userType == 4) {
                        ...
                        out.println("<h1>Selectati tipul si statusul concediilor de vizualizat</h1>");
                        out.print("<form action='");
                        out.print(request.getContextPath());
                        out.println("/viewcondepts2.jsp' method='post'>");
                        ...
                        out.println("<tr><td>Status</td><td><select name='dep'>");
                        ...
                        out.println("<tr><td>Departament</td><td><select name='dept'>");
