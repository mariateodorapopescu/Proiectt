                   ...
                   <%
                        try (PreparedStatement stmt = connection.prepareStatement("SELECT u.id AS nr_crt, d.nume_dep AS departament, u.nume as nume, u.prenume as prenume, u.username as usernamee, " +
                            ...
                            while (rs1.next()) {
                                ...
                                out.println("<td data-label='Status'><span class='status-icon status-neaprobat'><a href='NewFilee.jsp?id=" + rs1.getInt("nr_crt")+ "'><i class='ri-edit-circle-line'></i></a></span></td>");
