...
<body style="--bg:<%out.println(accent);%>; --clr:<%out.println(clr);%>; --sd:<%out.println(sidebar);%>">
            ...
            <form id="sporuriForm" method="POST" action="SporuriServlet">
                ...
                <label for="tipSpor">Tip Spor:</label>
                <select id="tipSpor" name="tip_spor" required>
                ...
                <label for="dataFinal">Data Sfârșit:</label>
                <input type="date" id="dataFinal" name="data_final" required>
                
                <label for="motiv">Justificare:</label>
                <textarea id="motiv" name="motiv" rows="4" required></textarea>
                
                <button type="submit" class="btn">Acordă Spor</button>
            </form>
        </section>
    </main>
