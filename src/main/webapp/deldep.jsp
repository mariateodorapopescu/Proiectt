...
<head>
    ...
    <title>Stergere departament</title>
</head>
<body>
<%
            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root", "student");
                ...
                if (!rs.next()) {
                    ...
                    if (rs.getString("tip").compareTo("4") != 0) {
                        ...
                        out.println("<form action='" + request.getContextPath() + "/DelDepServlet' method='post' class='login__form'>");
                        out.println("<h1 class='login__title'>Stergere departament</h1>");
                        out.println("<div class='login__inputs'>");
                        out.println("<div>");
                        out.println("<label for='' class='login__label'>Nume departament</label>");
                        out.println("<select name='username' class='login__input'>");
